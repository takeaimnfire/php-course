<html>
    ...
    <?php error_reporting (E_ALL ^ E_NOTICE); ?>
        ...
        <br/><br/>
        <h1 style="margin-top: 10%; text-align: center; font-family: Arial;">Subtraction</h1>
        ...
        <form method="post" action="subtraction.php" style="text-align: center; font-family: Arial;">
